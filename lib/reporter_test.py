...
def test_end():
    assert reporter.gen_end() == "</div></body></html>"

def test_mainheading():
    assert reporter.gen_main_heading("Test Heading") == "<h1 class='main_heading'>Test Heading</h1>"

def test_chapterheading():
    assert reporter.gen_chapter_heading("Hello World") == "<h3 class='heading'>Hello World</h3>"
